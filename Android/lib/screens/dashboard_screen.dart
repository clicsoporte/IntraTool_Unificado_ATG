            ...
            ElevatedButton.icon(
              ...
              onPressed: () async {
                ...
                try {
                  ...
                  if (mounted) {
                    messenger.showSnackBar(
                      SnackBar(content: Text('Error reportando avería: $e'), backgroundColor: Colors.red),
                    );
                  }
                }
              },
          ...
          ElevatedButton.icon(
            ...
            onPressed: () async {
              ...
              try {
                ...
                if (mounted) {
                  messenger.showSnackBar(
                    SnackBar(content: Text('Fallo de conexión enviando correo: $e'), backgroundColor: Colors.red),
                  );
                }
              }
            },
